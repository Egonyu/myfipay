...
- [ ] RADIUS over the management tunnel — the actual CGNAT enabler: nas row + walled garden + `radiusServerIP` use 10.77.0.1 for tunnel devices; handshake verified 2026-07-19 — remaining prereq: UFW allow RADIUS ports on wg0
